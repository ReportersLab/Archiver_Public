SELECT
	...
	Place.countryCode AS Place_countryCode,
	Place.country AS Place_country,
	Place.attributes AS Place_attributes,
	Place.url AS Place_url,
	Place.twitterId AS Place_twitterId,
	Place.boundingBox AS Place_boundingBox,
	Place.fullName AS Place_fullName,
	Place.type AS Place_type
FROM Status, User, Place
WHERE Status.userId = User.id 
  AND Status.placeId = Place.id
  AND Status.placeId = :placeId
